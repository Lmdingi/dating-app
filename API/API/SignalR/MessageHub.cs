...
namespace API.SignalR
{
    public class MessageHub(IUnitOfWork unitOfWork, IMapper mapper, IHubContext<PresenceHub> presenceHub) : Hub
    {
        public override async Task OnConnectedAsync()
        {
            ...
            await Clients.Caller.SendAsync("ReceiverMessageThread", message);
        }
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            {
                var connections = await PreseceTracker.GetConnectionsForUser(recipient.UserName);
        ...
        private async Task<Group> AddToGroup(string groupName)
        {
            ...
            if (group == null)
            {
                ...
                unitOfWork.MessageRepository.AddGroups(group);
            }
        ...
        private async Task<Group> RemoveFromMessagesGroup()
        {
            ...
            {
                unitOfWork.MessageRepository.RemoveGroup(connection);
                if(await unitOfWork.Complete()) return group;
            }
